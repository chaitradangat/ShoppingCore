...
{
    public partial class model_improvement_1_7 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductID", "AddressID", "Currency", "Name", "ProductDescription", "ProductTitle", "SellerID", "Unit", "UnitPrice" },
                values: new object[] { 1, 2, "USD", "IPhone", "A very costly smart phone", "Iphone X", 1, 4, 1200f });
