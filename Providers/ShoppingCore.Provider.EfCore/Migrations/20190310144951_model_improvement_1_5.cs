...
{
    public partial class model_improvement_1_5 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_Addresses_AddressID1",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Line1", "Line2", "Line3", "Line4", "Line5", 8, "CustomerCity", "CustomerCountry", null, "CustomerDistrict", "CustomerLandmark", "CustomerPincode", null },
                    { 2, "Line1", "Line2", "Line3", "Line4", "Line5", 10, "ProductCity", "ProductCountry", null, "ProductDistrict", "ProductLandmark", "ProductPincode", 1 }
                });
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductID", "AddressID", "AddressID1", "Currency", "Name", "ProductDescription", "ProductTitle", "SellerID", "Unit", "UnitPrice" },
                values: new object[] { 1, 2, null, "USD", "IPhone", "A very costly smart phone", "Iphone X", 1, 4, 1200f });
